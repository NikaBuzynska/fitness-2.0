...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var trainersSwiper = new _swiper.default('#swiper-trainers', {
  ...
  var reviewsSwiper = new _swiper.default('#swiper-reviews', {
    direction: 'horizontal',
    autoHeight: true,
    loop: false,
    slidesPerView: 1,
  ...
  var playButton = document.querySelector('.gym__play-button-wrapper');
  ...
  var buyPassButton = document.getElementById('buyPassButton');
  var passesBlock = document.getElementById('passesBlock');
  if (buyPassButton && passesBlock) {
    buyPassButton.addEventListener('click', function (event) {
      event.preventDefault();
      passesBlock.scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
  var footerTrainer = document.getElementById('footerTrainer');
  var trainersBlock = document.getElementById('trainersBlock');
  if (footerTrainer && trainersBlock) {
    footerTrainer.addEventListener('click', function (event) {
      event.preventDefault();
      trainersBlock.scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
  ...
  var nameLabel = nameInput.parentElement;
  var phoneInput = document.getElementById('phoneInput');
  phoneInput.addEventListener('input', function (event) {
    var input = event.target;
    input.value = input.value.replace(/[^0-9\s]/g, '');
  });
  var phoneLabel = phoneInput.parentElement;
...
},{"./modules/accordion/init-accordion":3,"./modules/modals/init-modals":4,"./modules/tabs/init-tabs":6,"./utils/ios-vh-fix":10,"./vendor/swiper":12}],2:[function(require,module,exports){
"use strict";
...
},{"./modals":5}],5:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":8,"../../utils/scroll-lock":11}],6:[function(require,module,exports){
"use strict";
...
},{"./tabs":7}],7:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":9}],11:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":9}],12:[function(require,module,exports){
